    ...
    <div className="p-4 md:p-6 w-full space-y-6 text-white min-h-screen bg-[#05050a]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className="lg:col-span-2 space-y-6 order-2 lg:order-none">
          ...
          {/* CARDS DE RESUMO (Mobile: 1 coluna, Tablet/PC: 2 colunas) */}
          ...
          {/* LISTAGEM DE SERVIÇOS (Tabela no PC, Cards no Mobile) */}
          <div className="bg-[#131425] border border-white/5 rounded-2xl md:p-6 shadow-2xl overflow-hidden">
                        ...
                        <div key={s.id} className="p-4 bg-black/20">
                            <div className="flex justify-between items-start mb-2">
                                <div>
                                    ...
                                    <div className="text-[10px] text-gray-400 mt-0.5">{s.cliente || "Cliente não informado"}</div>
                                </div>
             ...
             <div className="hidden md:block overflow-x-auto">
                <table className="w-full text-left text-sm">
                    ...
                    {servicos.length === 0 ? (
                        <tr><td colSpan={6} className="py-10 text-center text-gray-500 italic">Nenhum serviço registrado.</td></tr>
                    ) : (
                        servicos.map((s) => (
